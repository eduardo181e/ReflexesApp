  ...
  return (
    <View style={styles.alertContainer}>
      <View style={[styles.alertBox, currentTheme.container]}>
        <Text style={[{ fontSize: 20, marginBottom: 10}, , currentTheme.text]}>{extraParam}<Text>{'  '+duration1}</Text></Text>
      ...
      <TouchableOpacity style={[styles.button, styles.confirmButton]} onPress={handleConfirm1}>
        <Text style={currentTheme.text}>{trans.confirm}</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, styles.deleteButton]} onPress={handleDelete}>
        <Text style={currentTheme.text}>{trans.delete}</Text>
      </TouchableOpacity>
        </View>
      </View>
    </View>
