...
const Alert1 = ({ visible, message, extraParam, onClose, onConfirm,  duration, onDelete }) => {
  ...
  return (
    <View style={styles.alertContainer}>
      <View style={[styles.alertBox, currentTheme.container]}>
        <Text style={[{ fontSize: 20, marginBottom: 10}, , currentTheme.text]}>{extraParam}<Text>{'  '+duration}</Text></Text>
